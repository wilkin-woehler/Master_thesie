...
\begin{figure}[h]
\begin{center}
\subfloat[$\eta = 53.1\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_531_short.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.2\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_532_short.png}}\\
\subfloat[$\eta = 53.3\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_533_short.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.4\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_534_short.png}}
...
\begin{figure}[h]
\begin{center}
\subfloat[$\eta = 53.1\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_531_long.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.2\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_532_long.png}}\\
\subfloat[$\eta = 53.3\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_533_long.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.4\%$]{\includegraphics[width = 0.42 \textwidth]{pnt_534_long.png}}
...
The maximum probability is found by usual means of analysis executed in \autoref{eqn:exponential_maximization} - \autoref{eqn:exponential_maximization_end}.
\begin{align}
