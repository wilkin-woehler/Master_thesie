...
\begin{figure}[h]
\begin{center}
\subfloat[$\eta = 53.1\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_531_short.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.2\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_532_short.png}}\\
\subfloat[$\eta = 53.3\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_533_short.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.4\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_534_short.png}}
...
\begin{figure}[h]
\begin{center}
\subfloat[$\eta = 53.1\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_531_long.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.2\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_532_long.png}}\\
\subfloat[$\eta = 53.3\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_533_long.png}} \hspace{0.0cm}
\subfloat[$\eta = 53.4\%$]{\includegraphics[width = 0.45 \textwidth]{pnt_534_long.png}}
...
\begin{figure}[h]
\begin{center}
\subfloat[$\eta = 0.531$]{\includegraphics[width = 0.39 \textwidth]{acf_lc_531.png}} \hspace{0.5cm}
\subfloat[$\eta = 0.532$]{\includegraphics[width = 0.39 \textwidth]{acf_lc_532.png}} \\
\subfloat[$\eta = 0.533$]{\includegraphics[width = 0.39 \textwidth]{acf_lc_533.png}} \hspace{0.5cm}
\subfloat[$\eta = 0.534$]{\includegraphics[width = 0.39 \textwidth]{acf_lc_534.png}} \\
...
\section{Cluster growth and constant attachment rate}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6 \linewidth]{cluster_growth_example.pdf}
...
\begin{figure}[h]
\begin{center}
\subfloat[Histograms of the slopes from the linear regressions to third root of the largest cluster during the stable growth process. The histograms are for $\eta=53.1\%,\;53.2\%,\;53.3\%,\;53.4\%$.]{\includegraphics[width = 0.45 \textwidth]{const_growth_rate_histogram_comparison.pdf}} \hspace{0.5cm}
...
The tensor of gyration for a structure of $N$ particles with positions $\vec{r}^{\,(i)}$ is defined by
\begin{align}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.45 \linewidth]{varying_induction_time.pdf}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width = 0.55 \textwidth]{rel_uncertainty_k.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6 \linewidth]{nucleation_comparison_v2.pdf}
...
\subsection{Solid fraction in the thermodynamic limit of infinite volume}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6 \linewidth]{mod_nucleation_comparison_v2.pdf}
...
\section{Memory kernel analysis of nucleating ensemble}
...
We see on the left side of \autoref{fig:memory_kernel}, that the shape of a memory kernel slice at some reference time is rather simple. For this reason, we use a Gaussian fit to approximate the width and amplitude of the kernel. For this purpose, we neglect the Markovian part of the kernel at around $t_1-t_2 \approx 0$. To validate the fit results, we further use the FWHM whose the maximum is determined by the mean value of the peak's crest. As the properly normalized results for both methods are in good agreement, we can conclude that the shape of the memory kernel in this case is mostly defined by a width and an amplitude over time, which are depicted on the right of \autoref{fig:memory_kernel}.\\
\begin{figure}[h]
\begin{center}
\subfloat[Slice through memory kernel at the given reference time. The Markovian part is excluded from the analysis of the kernel width, that is depicted by the full width at half maximum (FWHM) and the Gaussian best fit. The FWHM is normalized to the value of a corresponding Gaussian curve.]{\includegraphics[width=0.32 \linewidth]{example_memory_kernel.pdf}} \hspace{0.5cm}
...
Bottom: Amplitude of the memory kernel slice on the one hand by using the mean value of the data around the maximum and on the other hand by using the amplitude derived from the best Gaussian fit. The amplitude derived from the maximum value is normalized to the value of a corresponding Gaussian curve.]{\includegraphics[width=0.52 \linewidth]{memory_kernel_shape.pdf}}
